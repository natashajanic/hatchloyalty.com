...
export interface IPureIndexPageProps {
  data: {
    allMarkdownRemark: {
      edges: Array<{
        node: {
...
export const PureIndexPage = (props: IPureIndexPageProps) => {
  const { data } = props
  const keywords = [
    'hatch',
    'hatch loyalty',
      ...
      <Wrapper is="article" py={5}>
          ...
          <div>
            <Box>
              ...
              <p>
                ...
                whistles today. Start small and iterate toward the best program
                for your business.
              </p>
            </Box>
            ...
            <Box>
              <h4>Measure</h4>
              <p>
                Good loyalty programs leverage member data to make more informed
                decisions. With Hatch, the best programs can understand
                engagement and make those decisions in real-time.
              </p>
            </Box>
            ...
            <Box>
              ...
              <p>
                ...
                access actionable insights that can be used to drive engagement
        ...
        <section>
          <Box>
            ...
            <p>
              ...
              and expensive. Hatch's platform approach to loyalty is designed to
              integrate with existing systems, products, and partners. Let us
              help you get to market faster and cheaper while still providing
              the flexibility to adapt into the future.
            </p>
          </Box>
          <Box>
          ...
          <div>
            <Box>
              ...
              <p>
                ...
                developer experience. Leave your worries in our hands and focus
                on your bottom line -- we’ve got you covered.
              </p>
              <ul>
        ...
        <section>
          ...
          <p>
            ...
            existing business systems and complimentary products &amp; services,
            giving you the flexibility and control to build the best solution
            for your business.
          </p>
          <Link to="/features">Learn More</Link>
        </section>
        ...
        <section>
          <blockquote>
            “Hatch is a robust, but easy to integrate customer loyalty platform
            that enables retailers to better understand and incentivize their
            customers…allowing them to engage their customers and grow their
...
class IndexPage extends React.Component<{}, {}> {
  render() {
    ...
    return (
      <StaticQuery
        query={query}
        render={data => <PureIndexPage {...this.props} data={data} />}
      />
    )
  }
}
