...
import HeroImageLP from 'src/images/hero-lp.jpg'
import ActiveCampaignForm from 'src/components/active-campaign-form'

const HeroImage = system({
  is: 'img',
  m: 0,
})
          ...
          >
            <Box width="50%">
              ...
              <Text
                ...
                fontSize={[3, 6]}
              >
                Hatch helps retailers build stronger relationships with
                their customers by reaching them in the moments that matter most.
              </Text>
            </Box>

            <Box width="50%">
              <HeroImage src={HeroImageLP} alt="" />
            </Box>
          </Wrapper>
        </Hero>
